    ...
    <div className="space-y-4">
        ...
        <div className="grid grid-cols-4 gap-2">
          {presets.map((preset) => (
            <button
              ...
              className="min-h-9 rounded-md border border-zinc-700 bg-zinc-900 px-2 text-xs font-semibold text-zinc-200 hover:border-cyan-400 hover:text-cyan-300"
      ...
      <div className={`grid gap-3 ${optionGrid}`}>
        {[
          ...
          <label
            key={key}
            className="flex min-h-11 min-w-0 items-center gap-2 rounded-md border border-zinc-800 bg-zinc-900/60 px-3 text-sm text-zinc-200"
          >
            <input
              type="checkbox"
